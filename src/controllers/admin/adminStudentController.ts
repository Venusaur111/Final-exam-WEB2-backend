...
export class AdminStudentController {
    ...
    public getRouter(): Router {
        ...
        router.put('/:id', async (req: Request, res: Response) => {
            try {
                const student = await this.adminUserService.updateStudent(req.params.id, req.body);
                res.json(student);
            } catch (error) {
        ...
        router.delete('/:id', async (req: Request, res: Response) => {
            try {
                const student = await this.adminUserService.deactivateStudent(req.params.id);
